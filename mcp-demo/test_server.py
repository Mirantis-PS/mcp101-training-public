...
async def test_server():
    ...
    try:
        ...
        print("\n2. Explore the server with the MCP Inspector (stdio transport):")
        print("   npx @modelcontextprotocol/inspector ./.venv/bin/python weather_server.py")
        print("\n3. Configure Claude Desktop / Claude Code with:")
        print('   "weather": {')
        print('     "command": "/absolute/path/to/mcp-demo/.venv/bin/python",')
        print('     "args": ["/absolute/path/to/mcp-demo/weather_server.py"]')
        print('   }')
        print("=" * 60)
